...
class Command
{
    ...
    static array $commands = ["/старт"];

    public static function addNewCommand(array $listNewCommand)
    {
        Command::$commands = array_merge(Command::$commands, $listNewCommand);
        print_r(Command::$commands);
    }

    public static function runBotCommand(){
        echo "<br>run bot command<br>";
    }
    public static function runBotChatEvent(){
        echo "<br>run bot chat event<br>";
    }
